...
{
    std::vector<employee_t> employee_manipulator::get_all() noexcept
    {
    ...
    std::vector<employee_t> employee_manipulator::get_like(const employee_t &entity) noexcept
    {
    ...
    employee_t employee_manipulator::get(int id) noexcept
    {
      auto* db_conn = this->parent()->get_dbconn();
    ...
    bool employee_manipulator::add(const employee_t &entity) noexcept
    {
    ...
    bool employee_manipulator::modify(const employee_t &entity) noexcept
    {
      std::stringstream command;
    ...
    bool employee_manipulator::remove(int id) noexcept
    {
    ...
    data_access_manager*
    employee_manipulator::parent() noexcept
    {
      return container_of(this, data_access_manager, m_employee_manipulator);
    }

    std::string
    employee_manipulator::glue_params(const employee_t &entity, std::string separator) noexcept
    {
