...
namespace app::dbaccess
{
    ...
    std::vector<offer_t> offer_manipulator::get_like(const offer_t &entity)const noexcept
    {
    ...
    bool offer_manipulator::add(const offer_t &entity)const noexcept
    {
    ...
    std::string
    offer_manipulator::glue_params(const offer_t &entity, std::string separator)const noexcept
    {
