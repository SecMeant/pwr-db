...
namespace app::dbaccess {
  ...
  credentials_manipulator::get_all() noexcept
  {

    auto *db_conn = this->parent()->get_dbconn();
    auto res = db_conn->query_res(
  ...
  std::vector<credentials_t>
  credentials_manipulator::get_like(const credentials_t &entity) noexcept
  {
  ...
  credentials_t
  credentials_manipulator::get(int id) noexcept
  {
    auto *db_conn = this->parent()->get_dbconn();
    auto command =
  ...
  bool
  credentials_manipulator::add(const credentials_t &entity) noexcept
  {
  ...
  bool
  credentials_manipulator::modify(const credentials_t &entity) noexcept
  {
    std::stringstream command;
  ...
  bool
  credentials_manipulator::remove(int id) noexcept
  {
    std::string command =
  ...
  data_access_manager *
  credentials_manipulator::parent() noexcept
  {
    return container_of(
