...
namespace app::dbaccess
{
    ...
    std::vector<tour_t> tour_manipulator::get_like(const tour_t &entity)const noexcept
    {
    ...
    bool tour_manipulator::add(const tour_t &entity)const noexcept
    {
    ...
    std::string
    tour_manipulator::glue_params(const tour_t &entity, std::string separator)const noexcept
    {
