...
namespace app::dbaccess
{
    ...
    std::vector<customer_t> customer_manipulator::get_like(const customer_t &entity)const noexcept
    {
    ...
    bool customer_manipulator::add(const customer_t &entity)const noexcept
    {
    ...
    std::string
    customer_manipulator::glue_params(const customer_t &entity, std::string separator)const noexcept
    {
